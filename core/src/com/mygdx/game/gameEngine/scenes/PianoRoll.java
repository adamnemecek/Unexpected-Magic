...
//		viewport.setScreenPosition(screenX, 0);
	...
	private void drawLanes(){
            for(int i  = 0; i < Constants.NUMBER_OF_LANES; i ++){
                batch.draw(noteLanes.getLaneTexture(i),Constants.LANE_WIDTH*i,Constants.SCORE_BOUNDS_LOWER,Constants.LANE_WIDTH,Constants.SCORE_BOUNDS_UPPER-Constants.SCORE_BOUNDS_LOWER);
            }
        }
